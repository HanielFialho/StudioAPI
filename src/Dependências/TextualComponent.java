...
public abstract class TextualComponent implements Cloneable {
	...
	/**
	 * Clones a textual component instance. The returned object should not reference
	 * this textual component instance, but should maintain the same key and value.
	 */
	@Override
	public abstract TextualComponent clone() throws CloneNotSupportedException;

	/**
	 * Writes the text data represented by this textual component to the specified
	 * JSON writer object. A new object within the writer is not started.
	 *
	 * @param writer
	...
	private static final class ArbitraryTextTypeComponent extends TextualComponent
		...
		public TextualComponent clone() throws CloneNotSupportedException {
			// Since this is a private and final class, we can just reinstantiate this class
			// instead of casting super.clone
	...
	/**
	 * Create a textual component representing a string literal. This is the default
	 * type of textual component when a single string literal is given to a method.
	 *
	 * @param textValue
	...
	/**
	 * Create a textual component representing a localized string. The client will
	 * see this text component as their localized version of the specified string
	 * <em>key</em>, which can be overridden by a resource pack.
	 * <p>
	 * If the specified translation key is not present on the client resource pack,
	 * the translation key will be displayed as a string literal to the client.
	 * </p>
	 *
	 * @param translateKey
	...
	/**
	 * Create a textual component representing a scoreboard value. The client will
	 * see their own score for the specified objective as the text represented by
	 * this component.
	 * <p>
	 ...
	 * @return The text component representing the specified scoreboard score (for
	 *         the viewing player), or {@code null} if an error occurs during JSON
	 *         serialization.
	 */
	...
	/**
	 * Create a textual component representing a scoreboard value. The client will
	 * see the score of the specified player for the specified objective as the text
	 ...
	 *
	 * @param playerName
	 *            The name of the player whos score will be shown. If this string
	 ...
	 *            The name of the objective for which to display the score.
	 * @return The text component representing the specified scoreboard score for
	 *         the specified player, or {@code null} if an error occurs during JSON
	 *         serialization.
	 */
	...
	/**
	 * Create a textual component representing a player name, retrievable by using a
	 * standard minecraft selector. The client will see the players or entities
	 * captured by the specified selector as the text represented by this component.
	 * <p>
	 * <b>This method is currently guaranteed to throw an
	 * {@code UnsupportedOperationException} as it is only supported on snapshot
	 * clients.</b>
	 ...
	 * @return The text component representing the name of the entities captured by
	 *         the selector.
	 */
